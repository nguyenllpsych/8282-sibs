...
```{r sex-AG, warning=FALSE, message=FALSE}
...
```{r sex-CON, warning=FALSE, message=FALSE}
...
```{r sex-HA, warning=FALSE, message=FALSE}
...
summary(lm(iy ~ io * Factor1, data = relaAG_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Aggression intercept", digits = 3) %>% 
  kable_styling()
summary(lm(iy ~ io * Factor2, data = relaAG_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Aggression intercept", digits = 3) %>% 
  kable_styling()
summary(lm(sy ~ so * Factor1, data = relaAG_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Aggression slope", digits = 3) %>% 
  kable_styling()
...
```{r rela-CON, warning = F, message = F}
#### younger siblings
...
summary(lm(iy ~ io * Factor1, data = relaCON_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Control intercept", digits = 3) %>% 
  kable_styling()
summary(lm(iy ~ io * Factor2, data = relaCON_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Control intercept", digits = 3) %>% 
  kable_styling()
summary(lm(sy ~ so * Factor1, data = relaCON_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Control slope", digits = 3) %>% 
  kable_styling()
...
summary(lm(iy ~ io * Factor1, data = relaHA_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Harm Avoidance intercept", digits = 3) %>% 
  kable_styling()
summary(lm(iy ~ io * Factor2, data = relaHA_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Harm Avoidance intercept", digits = 3) %>% 
  kable_styling()
summary(lm(sy ~ so * Factor1, data = relaHA_o))$coefficients %>%
  knitr::kable(caption = "Predicting older siblings's Harm Avoidance slope", digits = 3) %>% 
  kable_styling()
